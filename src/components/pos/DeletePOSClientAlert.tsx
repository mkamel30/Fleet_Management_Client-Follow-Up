...
export function DeletePOSClientAlert({ clientId, open, onOpenChange }: DeletePOSClientAlertProps) {
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent dir="rtl">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            هذا الإجراء لا يمكن التراجع عنه. سيؤدي هذا إلى حذف العميل وجميع سجلات المكالمات المرتبطة به بشكل دائم.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
